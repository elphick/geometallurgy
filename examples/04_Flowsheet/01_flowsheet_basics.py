...
fs: Flowsheet = Flowsheet().from_streams([obj_strm, obj_strm_1, obj_strm_2])
...
fs2: Flowsheet = Flowsheet().from_streams([obj_strm, obj_strm_1, obj_strm_2, obj_strm_3, obj_strm_4, obj_strm_5])
...
stream_data: Dict[str, Sample] = fs.streams_to_dict()
print(stream_data.keys())

# %%
# We will replace stream 2 with the same data as stream 1.

new_stream: Sample = deepcopy(fs.get_edge_by_name('stream 1'))
